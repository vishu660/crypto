...
<head>
    ...
    <title>Frequently Asked Question - Fundrows</title>
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">FAQ</h4>
                </div>
            </div>
            <!-- End:Title -->

            <div class="row">
                <div class="col-xxl-8 offset-xxl-2 text-md-center">
                    <div class="d2c_faq_main">
                        <h2 class="text-capitalize fw-bold">Frequently asked questions</h2>
                        <p>Get to know more about ready-to-use Crypto dashboard templates</p>
                        <div class="accordion" id="faq">
                            <div class="accordion-item mb-3">
                                <h2 class="accordion-header" id="faq_1_heading_1">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#faq_1_content_1" aria-expanded="true"
                                        aria-controls="faq_1_content_1">
                                        Why no one likes selling, here's how to fight back?
                                    </button>
                                </h2>
                                <div id="faq_1_content_1" class="accordion-collapse collapse show"
                                    aria-labelledby="faq_1_heading_1" data-bs-parent="#faq">
                                    <div class="accordion-body text-start bg-primary bg-opacity-10">
                                        <p class="mb-0 text-secondary">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamu terry richardson ad squid. 3 wolf moon officia aute, cupidatat skatboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moo</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item mb-3">
                                <h2 class="accordion-header" id="faq_1_heading_2">
                                    <button class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#faq_1_content_2"
                                        aria-expanded="true" aria-controls="faq_1_content_2">
                                        Where does it come from ?
                                    </button>
                                </h2>
                                <div id="faq_1_content_2" class="accordion-collapse collapse"
                                    aria-labelledby="faq_1_heading_2" data-bs-parent="#faq">
                                    <div class="accordion-body text-start bg-primary bg-opacity-10">
                                        <p class="mb-0 text-secondary">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamu terry richardson ad squid. 3 wolf moon officia aute, cupidatat skatboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moo</p>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item mb-3">
                                <h2 class="accordion-header" id="faq_1_heading_3">
                                    <button class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#faq_1_content_3"
                                        aria-expanded="true" aria-controls="faq_1_content_3">
                                        Do I have to start my Epora course at a certain time?
                                    </button>
                                </h2>
                                <div id="faq_1_content_3" class="accordion-collapse collapse"
                                    aria-labelledby="faq_1_heading_3" data-bs-parent="#faq">
                                    <div class="accordion-body text-start bg-primary bg-opacity-10">
                                        <p class="mb-0 text-secondary">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamu terry richardson ad squid. 3 wolf moon officia aute, cupidatat skatboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moo</p>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item mb-3">
                                <h2 class="accordion-header" id="faq_1_heading_4">
                                    <button class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#faq_1_content_4"
                                        aria-expanded="true" aria-controls="faq_1_content_4">
                                        Where can I go for help?
                                    </button>
                                </h2>
                                <div id="faq_1_content_4" class="accordion-collapse collapse"
                                    aria-labelledby="faq_1_heading_4" data-bs-parent="#faq">
                                    <div class="accordion-body text-start bg-primary bg-opacity-10">
                                        <p class="mb-0 text-secondary">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamu terry richardson ad squid. 3 wolf moon officia aute, cupidatat skatboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moo</p>
                                    </div>
                                </div>
            ...
            <!-- any question part -->
            <div class="bg-success bg-opacity-10 mt-4 p-3 p-md-5 d2c_another_question text-center">
                <div class="mb-3">
                    <img src="{{ asset('assets/images/profile/profile-1.jpg') }}" width="50" height="50" class="rounded-circle border border-2 border-dark object-fit-cover" alt="profile image">
                    <img src="{{ asset('assets/images/profile/profile-2.jpg') }}" width="50" height="50" class="rounded-circle border border-2 border-dark object-fit-cover" alt="profile image">
                    <img src="{{ asset('assets/images/profile/profile-3.jpg') }}" width="50" height="50" class="rounded-circle border border-2 border-dark object-fit-cover" alt="profile image">
                </div>
                <h3 class="text-capitalize fw-semibold">Still have questions</h3>
                <p class="text-secondary">Can't find the answer your're looking for ? Please chat to our friendly team.</p>
                <a href="{{ route('user.pages.support') }}" class="btn btn-primary">Chat With Us</a>
            </div>
