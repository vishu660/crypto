        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">Progress</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="row">
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Default Progress</h5>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Height Progress</h5>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Labels Progress</h5>
                            <div class="progress mb-2">
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Striped Progress</h5>
                            <div class="progress mb-2">
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Background Progress</h5>
                            <div class="progress mb-2">
                ...
                <!-- Striped animation progress -->
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Striped animation</h5>
                            <div class="progress mb-2">
                            ...
                            <div class="progress mb-2">
                                <div class="progress-bar progress-bar-striped progress-bar-animated bg-warning" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100" style="width: 60%"></div>
                            </div>
                            <div class="progress mb-2">
                                <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- Backgrounds with label progress -->
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Backgrounds with label</h5>
                            <div class="progress mb-2">
                ...
                <!-- striped Animation With Label progress -->
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">striped Animation With Label</h5>
                            <div class="progress mb-2">
                            ...
                            <div class="progress mb-2">
                                <div class="progress-bar progress-bar-striped progress-bar-animated bg-warning" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100" style="width: 60%">60%</div>
                            </div>
                            <div class="progress mb-2">
