...
<head>
    ...
    <!-- flatpickr cdn -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/flatpickr/4.6.13/flatpickr.min.css" referrerpolicy="no-referrer">
    <!-- Font Awesome CDN -->
...
<body>
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">Advanced Form</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold mb-3">Validated Form</h5>
                            <form class="form-validation" novalidate>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea cols="30" rows="4" class="form-control" placeholder="Write your queries" required></textarea>
                                </div>
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-primary text-capitalize">Submit</button>
                                    <a href="#" class="btn btn-light text-capitalize ms-2">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-3 text-capitalize">Date and time picker</h5>
                            <div class="row">
                                <div class="col-xl-6">
                                    <input type="text" id="basic" placeholder="Select Date.." class="form-control mb-3" data-input>
                                    <input type="text" id="dateTime" placeholder="Date and Times.." class="form-control mb-3" data-input>
                                    <input type="text" id="time_picker" placeholder="Time Picker.." class="form-control mb-3" data-input>
                                    <input type="text" id="min_max_dates" placeholder="Min and Max Dates.." class="form-control mb-3" data-input>
                                    <input type="text" id="min_dates" placeholder="Min Dates.." class="form-control mb-3" data-input>
                                </div>
                                <div class="col-xl-6">
                                    <input type="text" id="fixed_day_dates" placeholder="Fixed Dates.." class="form-control mb-3" data-input>
                                    <input type="text" id="disabling_dates" placeholder="Disabling Dates.." class="form-control mb-3" data-input>
                                    <input type="text" id="disabling_range" placeholder="Disabling range Dates.." class="form-control mb-3" data-input>
                                    <input type="text" id="multiple_select" placeholder="Multiple Select Dates.." class="form-control mb-3" data-input>
                                    <input type="text" id="range_select" placeholder="Range Select Dates.." class="form-control" data-input>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-3 text-capitalize">Form Step And Validation</h5>
                            <form id="d2c_form_step" action="#!">
                                <!-- start step indicators -->
                                <div class="d2c_step_form_header d-flex mb-4">
                                ...
                                <div class="mb-3 step">
                                    <div class="row">
                                        <div class="col-md mb-3">
                                            ...
                                            <input type="text" class="form-control d2c_step_form_input" placeholder="Enter First Name" oninput="this.className = ''" name="fname">
                                        </div>
                                        <div class="col-md mb-3">
                                            <label class="form-label">Last Name</label>
                                            <input type="text" class="form-control d2c_step_form_input" placeholder="Enter Last Name" oninput="this.className = ''" name="name">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md mb-3">
                                            <label class="form-label">Email Address</label>
                                            <input type="email" class="form-control d2c_step_form_input" placeholder="Enter Email Address" oninput="this.className = ''" name="email">
                                        </div>
                                        <div class="col-md mb-3">
                                            <label class="form-label">Password</label>
                                            <input type="password" class="form-control d2c_step_form_input" placeholder="Enter Your Password" oninput="this.className = ''" name="password">
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Write you Message</label>
                                        <textarea cols="30" rows="4" class="form-control d2c_step_form_input" oninput="this.className = ''" placeholder="Write your queries"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="step mb-3">
                                    <div class="row">
                                        <div class="col-md mb-3">
                                            ...
                                            <input type="url" class="form-control" placeholder="Linked In URL" oninput="this.className = ''" name="linkedin">
                                        </div>
                                        <div class="col-md mb-3">
                                            <label class="form-label">Twitter</label>
                                            <input type="url" class="form-control" placeholder="Twitter URL" oninput="this.className = ''" name="twitter">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md mb-3">
                                            <label class="form-label">Youtube</label>
                                            <input type="url" class="form-control" placeholder="Youtube URL" oninput="this.className = ''" name="Youtube">
                                        </div>
                                        <div class="col-md mb-3">
                                            <label class="form-label">Facebook</label>
                                            <input type="url" class="form-control" placeholder="Facebook URL" oninput="this.className = ''" name="facebook">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="step mb-3">
                                    <div class="row">
                                        <div class="col-md mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Full name" oninput="this.className = ''" name="fullname" required>
                                        </div>
                                        <div class="col-md mb-3">
                                            <label class="form-label">Your Mobile Number</label>
                                            <input type="tel" class="form-control" placeholder="Mobile" oninput="this.className = ''" name="mobile" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md mb-3">
                                            <label class="form-label">Your Address</label>
                                            <input type="text" class="form-control" placeholder="Address" oninput="this.className = ''" name="address" required>
                                        </div>
                                        <div class="col-md mb-3">
                                            <label class="form-label">Postal Code</label>
                                            <input type="number" class="form-control" placeholder="Mobile" oninput="this.className = ''" name="postalcode" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="step mb-3">
                                    <div class="row">
                                        <div class="col-md mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Your School Name" oninput="this.className = ''" name="school">
                                        </div>
                                        <div class="col-md mb-3">
                                            <label class="form-label">Your college</label>
                                            <input type="text" class="form-control" placeholder="Your College Name" oninput="this.className = ''" name="college">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md mb-3">
                                            <label class="form-label">Your University</label>
                                            <input type="text" class="form-control" placeholder="Your University Name" oninput="this.className = ''" name="university">
                                        </div>
                                        <div class="col-md mb-3">
                                            <label class="form-label">YOur HomeTown</label>
                                            <input type="text" class="form-control" placeholder="Your Hometown" oninput="this.className = ''" name="hometown">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-footer d-flex justify-content-end">
                                    ...
                                    <button type="submit" id="nextBtn" class="btn btn-primary" onclick="nextPrev(1)">Next</button>
                                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">multi-step Form validation</h5>
                            <!-- multi step form -->
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input maxlength="100" type="text" required="required" class="form-control my-2" placeholder="Enter First Name">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Last Name</label>
                                                <input maxlength="100" type="text" required="required" class="form-control my-2" placeholder="Enter Last Name">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Address</label>
                                                <textarea required="required" class="form-control my-2" placeholder="Enter your address"></textarea>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input maxlength="200" type="text" required="required" class="form-control my-2" placeholder="Enter Company Name">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Company Address</label>
                                                <input maxlength="200" type="text" required="required" class="form-control my-2" placeholder="Enter Company Address">
                                            </div>
    ...
    <!-- flatpickr -->
    <script src="{{ asset('assets/js/flatpickr.min.js') }}" referrerpolicy="no-referrer"></script>

    <!-- custom js -->
    <script src="{{ asset('assets/js/datePicker.js') }}"></script>
    <!-- advanced form js -->
    <script src="{{ asset('assets/js/advancedFrom.js') }}"></script>
