        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">Invoice</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="card d2c_invoice">
                ...
                <div class="d2c_invoice_header p-4">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex align-items-center justify-content-md-end text-end mb-4">
                            <a href="{{ route('user.pages.components.createInvoice') }}" class="btn bg-primary bg-opacity-10 text-primary text-capitalize d2c_create_invoice_btn">Create invoice <i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-xl order-2 order-md-1">
                            <div class="d2c_invoice_content">
                                <p class="mb-2">47 Holmes Green, Sophiebury, WP9M 3ZZ</p>
                                <p class="mb-2">Email: example@gmail.com</p>
                                <p class="mb-0">Phone: +91 5264 251 325</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-5 col-xxl-3 order-1 order-md-2 mb-4 mb-md-0">
                            <p class="mb-2"><span class="fw-semibold me-1">Invoice ID:</span> #2365546</p>
                            <p class="mb-2"><span class="fw-semibold me-1">Status:</span><span class="text-success fw-bold">Paid</span></p>
                            <button class="btn btn-primary px-3 py-1 rounded">Send</button>
                            <button class="btn d2c_print_btn fs-6 px-2 py-1 text-success rounded bg-success bg-opacity-25"><i class="fas fa-print"></i></button>
                        </div>
                    </div>
                    <hr class="mb-0">
                </div>
                <div class="card-body pt-0">
                    <div class="d2c_invoice_body">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl">
                                <div class="d2c_invoice_content">
                                    ...
                                    <h6 class="mb-2 fw-bold">Designtocodes</h6>
                                    <p class="mb-2">58 Jamie Ways, North Faye, Q5 5ZP</p>
                                    <p class="mb-2">Email: example@gmail.com</p>
                                    <p class="mb-0">Phone: +91 5264 521 943</p>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl mt-4 mt-xl-0 justify-content-md-end d-flex">
                                <div class="d2c_invoice_content">
                        ...
                        <!-- invoice list  -->
                        <div class="d2c_invoice_list card table-responsive mt-4 bg-success bg-opacity-10">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th style="min-width: 210px;">Item</th>
                                        <th style="min-width: 100px;">Quantity</th>
                                        <th style="min-width: 11.875rem;">Unit Cost</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>01</td>
                                        <td>$399.99</td>
                                        <td class="text-end">$399.99</td>
                                    </tr>
                                    <tr>
                                        <td>Custom Services</td>
                                        <td>05</td>
                                        <td>$250.00</td>
                                        <td class="text-end">$2500.00</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="text-end">
                                        <td colspan="3"><b>Tax(10%)</b></td>
                                        <td class="text-end">$632.00</td>
                                    </tr>
                                    <tr class="text-end">
                                        <th colspan="3">Total</th>
                                        <th class="text-end">$4,264.99</th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
