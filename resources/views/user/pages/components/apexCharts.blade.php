...
<body>
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">Apex charts</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="row">
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-header">
                            <h5 class="text-capitalize fw-semibold">Volume Bar Chart</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-success bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">Future Treading Candle Stick </h5>
                            <div id="d2c_candle_stick_chart"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-success bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">Liquidity Line Chart</h5>
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">Overview Line Chart</h5>
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-success bg-opacity-10">
                        <div class="card-body">
                            ...
                            <div id="d2c_stacked_bar_chart"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-danger bg-opacity-10">
                        <div class="card-header">
                            <h5 class="text-capitalize fw-semibold">Trending Pie Chart</h5>
                        </div>
                        <div class="card-body">
                            <div id="d2c_donutChart"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-warning bg-opacity-10">
                        <div class="card-header">
                            <h5 class="text-capitalize fw-semibold">radial bar Chart</h5>
                        </div>
                        <div class="card-body">
                            <div id="d2c_radialBarChart"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
    ...
    <script src="{{ asset('assets/js/chart/apexChart.js') }}"></script>
