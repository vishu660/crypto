...
<body>
        ...
        <div class="d2c_sidebar offcanvas-lg offcanvas-start px-2 py-4" tabindex="-1" id="d2c_sidebar">
            <div class="d-flex flex-column">
                ...
                <ul class="navbar-nav flex-grow-1">
                    ...
                    <!-- Menu Item -->
                    <li class="nav-item">
                        <a class="nav-link" href="../../pages/exchange.html">
                            <span class="d2c_icon">
                    ...
                    <!-- Menu Item -->
                    <li class="nav-item">
                        <a class="nav-link" href="../../pages/activity.html">
                            <span class="d2c_icon">
                    ...
                    <li class="nav-item active">
                        ...
                        <ul class="sub-menu collapse show" id="components">
                            ...
                            <!-- Child Menu Item -->
                            <li class="nav-item">
                                <a class="nav-link active" href="../../pages/components/map.html">
                                    <span> Maps </span>
                                </a>
                            </li>
                            <!-- End:Child Menu Item -->
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">Alerts</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="row">
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <!-- background -->
                            <h5 class="mb-3 text-capitalize">Background colors</h5>
                            ...
                            <!-- pill badges -->
                            <h5 class="mb-3 mt-3 text-capitalize">Pill Badges</h5>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <!-- position -->
                            <h5 class="mb-3 text-capitalize">Positioned badges</h5>
                            ...
                            <button type="button" class="btn btn-success position-relative m-2">
                                Inbox
                                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                                    23+
                                    <span class="visually-hidden">unread messages</span>
                            ...
                            <h5 class="text-capitalize my-3">Color match positioned badges</h5>
                            <button type="button" class="btn btn-primary position-relative m-2">
                                Inbox
                            ...
                            <button type="button" class="btn btn-info position-relative m-2">
                                Inbox
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <!-- Different position badges -->
                            <h5 class="mb-3 text-capitalize">Different Positioned badges</h5>
                            <button type="button" class="btn btn-primary position-relative m-2">
                                Profile
                            ...
                            <h5 class="my-3 text-capitalize">More position badges</h5>
                            <button type="button" class="btn btn-info position-relative m-2">
                                Profile
                                <span class="position-absolute top-100 start-0 translate-middle p-2 bg-danger border border-light rounded-circle">
                                    <span class="visually-hidden">New alerts</span>
                                </span>
                            </button>
                            <button type="button" class="btn btn-warning position-relative m-2">
                                Profile
                                <span class="position-absolute top-100 start-50 translate-middle p-2 bg-danger border border-light rounded-circle">
                                    <span class="visually-hidden">New alerts</span>
                                </span>
                            </button>
                            <button type="button" class="btn btn-secondary position-relative m-2">
                            ...
                            <button type="button" class="btn btn-dark position-relative m-2">
                                Profile
                            ...
                            <button type="button" class="btn btn-danger position-relative m-2">
                                Profile
                ...
                <!-- color match with different position badges -->
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-3 text-capitalize">different position badges</h5>
                            <button type="button" class="btn btn-primary position-relative m-2">
                                Inbox
                            ...
                            <h5 class="my-3 text-capitalize">color match with different position badges</h5>

                            <button type="button" class="btn btn-primary position-relative m-2">
                                Inbox
                                <span class="position-absolute top-0 start-0 translate-middle badge rounded-pill bg-primary border border-light">
                                    55+
                                    <span class="visually-hidden">unread messages</span>
                                </span>
                            </button>
                            ...
                            <button type="button" class="btn btn-info position-relative m-2">
                                Inbox
                                <span class="position-absolute top-100 start-0 translate-middle badge rounded-pill bg-info border border-light">
                                    75+
                                    <span class="visually-hidden">unread messages</span>
                                </span>
                            </button>
                            ...
                            <button type="button" class="btn btn-warning position-relative m-2">
                                Inbox
                                <span class="position-absolute top-100 start-100 translate-middle badge rounded-pill bg-warning border border-light">
                                    25+
                                    <span class="visually-hidden">unread messages</span>
                                </span>
                            </button>
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-3 text-capitalize">Icon badges</h5>
                            <button type="button" class="btn btn-primary position-relative m-2">
                                <i class="fas fa-bell"></i>
                                <span class="position-absolute top-0 start-0 translate-middle badge rounded-pill bg-danger">
                                    5+
                            ...
                            <h5 class="my-3 text-capitalize">color match with different Icon badges</h5>
                ...
                <!-- different type of button badges -->
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-3 mt-3 text-capitalize">Different type of Buttons badges</h5>
                            <button type="button" class="btn btn-primary m-1">
                                Notifications <span class="badge bg-danger">4</span>
                            </button>
                            <button type="button" class="btn btn-secondary m-1">
                                Notifications <span class="badge bg-secondary border border-light">4</span>
                            </button>
                            <button type="button" class="btn btn-warning m-1">
                                <span class="badge bg-danger">4</span> Notifications
                            </button>
                            <button type="button" class="btn btn-success m-1">
                                <span class="badge bg-success border border-light">4</span> Notifications
                            </button>
                            <button type="button" class="btn btn-dark m-1">
                                <span class="badge bg-danger">New</span> Notifications
                            </button>
                            <button type="button" class="btn btn-danger m-1">
                                Notifications <span class="badge bg-danger border border-light">New</span>
                            </button>
                            <button type="button" class="btn btn-primary position-relative m-2">
                                <span class="badge bg-danger">New</span> Notifications
                                <span class="position-absolute top-0 start-0 translate-middle badge rounded-pill bg-primary border border-light">
                            ...
                            <button type="button" class="btn btn-info position-relative m-2">
                                Notifications <span class="badge bg-info border border-light">New</span>
                                <span class="position-absolute top-0 start-0 translate-middle badge rounded-pill bg-info border border-light">
                                    25+
                                    <span class="visually-hidden">unread messages</span>
                                </span>
                            </button>
                            <button type="button" class="btn btn-secondary position-relative m-2">
                                <span class="badge bg-danger">New</span> Notifications
                                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-info border border-light">
                                    75+
                                    <span class="visually-hidden">unread messages</span>
                                </span>
                            </button>
                            <button type="button" class="btn btn-dark position-relative m-2">
                                Notifications <span class="badge bg-danger">New</span>
                                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-info border border-light">
                                    65+
                                    <span class="visually-hidden">unread messages</span>
                                </span>
    ...
    <script src="../../assets/js/sweetAlert/sweetalert_main.js"></script>
    <!-- custom js -->
