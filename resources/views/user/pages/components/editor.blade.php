...
<body>
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">Editor</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    <div class="card bg-danger bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold mb-3">Quill Editor</h5>
                            <!-- editor -->
                ...
                <div class="col-12 mb-4">
                    <div class="card bg-warning bg-opacity-10">
                        <div class="card-body">
                            <h5 class="mb-3 text-capitalize">CKE Editor</h5>
                            <!-- eke editor -->
                            <div id="cke_editor" class="form-control"></div>
                        </div>
                    </div>
                </div>
                <!-- tinymce editor -->
                <div class="col-12">
                    <div class="card bg-success bg-opacity-10">
                        <div class="card-body">
                            <h5 class="mb-3 text-capitalize">Tinymce Editor</h5>
                            <!-- tinymce editor -->
                            <textarea id="tinymce-editor" class="form-control">
                                <p>Hello world</p>
                            </textarea>
                        </div>
                    </div>
    ...
    <!-- tinymce editor -->
    <script src="https://cdn.tiny.cloud/1/no-api-key/tinymce/6.6.2-27/tinymce.min.js"></script>
