...
<body>
    ...
    <div class="d2c_wrapper">
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row">
                <!-- basic table -->
                <div class="col-lg-12 col-xxl-6 mb-4">
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Basic Table</h5>
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col" style="min-width: 120px;">Id</th>
                                            <th scope="col" style="min-width: 120px;">First</th>
                                            <th scope="col" style="min-width: 120px;">Last</th>
                                            <th scope="col" style="min-width: 120px;">Handle</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                ...
                <!-- striped table -->
                <div class="col-lg col-xxl-6 mb-4">
                    <div class="card bg-secondary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Striped Table</h5>
                            <div class="table-responsive">
                ...
                <div class="col-xl-6 mb-4">
                    <div class="card bg-success bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Hoverable Table</h5>
                            <div class="table-responsive">
                ...
                <div class="col-xl-6 mb-4">
                    <div class="card bg-warning bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Border Table</h5>
                            <div class="table-responsive">
                ...
                <div class="col-xl-6 mb-4">
                    <div class="card bg-danger bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Borderless Table</h5>
                            <div class="table-responsive">
                ...
                <div class="col-xl-6 mb-4">
                    <div class="card bg-info bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Dark Table</h5>
                            <div class="table-responsive">
                ...
                <div class="col-xl-6 mb-4">
                    <div class="card bg-dark bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">variants Table</h5>
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                ...
                <div class="col-xl-6 mb-4">
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Dark striped Table</h5>
                            <div class="table-responsive">
                ...
                <div class="col-lg mb-4">
                    <div class="card">
                        <div class="card-body bg-success bg-opacity-10">
                            <h5 class="fw-semibold mb-4">Live Farm</h5>
                            <div class="table-responsive">
                                <table class="table align-middle mb-0">
                                    <thead>
                                        <tr>
                                            <th style="min-width: 110px">Coins</th>
                                            <th style="min-width: 110px">APR</th>
                                            <th style="min-width: 110px">Multiplier</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Bitcoin</td>
                                            <td>29.5% <i class="fas fa-upload text-success"></i></td>
                                            <td class="text-success">40x</td>
                                            <td class="text-success">Complete</td>
                                        </tr>
                                        <tr>
                                            <td>Ethereum</td>
                                            <td>32.2% <i class="fas fa-download text-danger"></i></td>
                                            <td class="text-success">35x</td>
                                            <td class="text-success">Complete</td>
                                        </tr>
                                        <tr>
                                            <td>Ripple</td>
                                            <td>27.8% <i class="fas fa-upload text-success"></i></td>
                                            <td class="text-danger">42x</td>
                                            <td class="text-danger">Incomplete</td>
                                        </tr>
                                        <tr>
                                            <td>Litecoin</td>
                                            <td>30.6% <i class="fas fa-upload text-success"></i></td>
                                            <td class="text-success">38x</td>
                                            <td class="text-success">Complete</td>
                                        </tr>
                                        <tr>
                                            <td>Cardano</td>
                                            <td>26.9% <i class="fas fa-download text-danger"></i></td>
                                            <td class="text-success">45x</td>
                                            <td class="text-warning">Pending</td>
                                        </tr>
                                        <tr>
                                            <td>Stellar</td>
                                            <td>28.3% <i class="fas fa-upload text-success"></i></td>
                                            <td class="text-danger">43x</td>
                                            <td class="text-success">Complete</td>
                                        </tr>
                                        <tr>
                                            <td>Polkadot</td>
                                            <td>31.9% <i class="fas fa-download text-danger"></i></td>
                                            <td class="text-danger">36x</td>
                                            <td class="text-danger">Incomplete</td>
                                        </tr>
                                        <tr>
                                            <td>Chainlink</td>
                                            <td>25.6% <i class="fas fa-upload text-success"></i></td>
                                            <td class="text-success">48x</td>
                                            <td class="text-warning">Pending</td>
                                        </tr>
                                        <tr>
                                            <td>VeChain</td>
                                            <td>33.7% <i class="fas fa-download text-danger"></i></td>
                                            <td class="text-success">33x</td>
                                            <td class="text-warning">Pending</td>
                                        </tr>
                                        <tr>
                                            <td>Tron</td>
                                            <td>29.1% <i class="fas fa-upload text-success"></i></td>
                                            <td class="text-danger">41x</td>
                                            <td class="text-success">Complete</td>
                                        </tr>
                                        <tr>
                                            <td>Monero</td>
                                            <td>34.5% <i class="fas fa-upload text-success"></i></td>
                                            <td class="text-success">30x</td>
                                            <td class="text-success">Complete</td>
                                        </tr>
                                    </tbody>
                                </table>
