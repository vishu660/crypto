...
<head>
    ...
    <!-- vector map css -->
    <link rel="stylesheet" href="{{ asset('lib/jvectormap/jsvectormap.min.css') }}">
    <!-- main css -->
...
<body>
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize">Maps</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="row">
                ...
                <div class="col-xl-6 mb-4">
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="fw-semibold mb-4">Vector World Map</h5>
                            <div id="world_map" class="d2c_map"></div>
                        </div>
                    </div>
                </div>
                <!-- USA map -->
                <div class="col-xl-6 mb-4">
                    <div class="card bg-dangerbg-opacity-10">
                        <div class="card-body">
                            <h5 class="fw-semibold mb-4">Vector USA Map</h5>
                            <div id="usa_map" class="d2c_map"></div>
                        </div>
                    </div>
                </div>
                <!-- Canada map -->
                <div class="col-xl-6 mb-4">
                    <div class="card bg-success bg-opacity-10">
                        <div class="card-body">
                            <h5 class="fw-semibold mb-4 mt-3">Vector Canada Map</h5>
                            <div id="canada_map" class="d2c_map"></div>
                        </div>
                    </div>
                </div>
                <!-- Canada map -->
                <div class="col-xl-6 mb-4">
                    <div class="card bg-warning bg-opacity-10">
                        <div class="card-body">
                            <h5 class="fw-semibold mb-4 mt-3">Vector Australia Map</h5>
                            <div id="australia_map" class="d2c_map"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- all map js file link -->
    <script src="{{ asset('lib/jvectormap/jsvectormap.min.js') }}"></script>
    <script src="{{ asset('lib/jvectormap/world.js') }}"></script>
    <script src="{{ asset('lib/jvectormap/usa_map.js') }}"></script>
    <script src="{{ asset('lib/jvectormap/canada_map.js') }}"></script>
    <script src="{{ asset('lib/jvectormap/australia_map.js') }}"></script>
    <script src="{{ asset('lib/jvectormap/main_map.js') }}"></script>
    <!-- custom js -->
