        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">Spinners</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="row">
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Border spinner</h5>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Growing spinner</h5>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Button spinner</h5>
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">spinner sizes</h5>
                            ...
                            <div class="spinner-grow text-success" style="width: 1.5rem; height: 1.5rem;" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
                            <div class="spinner-grow" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
                            <div class="spinner-grow text-dark" style="width: 2.5rem; height: 2.5rem;" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Alignment Spinner</h5>
                            <div class="d-flex justify-content-left align-items-center">
                                <div class="spinner-border text-primary" role="status">
                                    <span class="visually-hidden">Loading...</span>
                                </div>
                                <h6 class="mb-0 ms-2">left Spinner</h6>
                            </div>
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="spinner-border text-warning" role="status">
                                    <span class="visually-hidden">Loading...</span>
                                </div>
                                <h6 class="mb-0 ms-2">Middle Spinner</h6>
                            </div>
                            <div class="d-flex justify-content-end align-items-center">
                                <h6 class="mb-0 me-2">Right Spinner</h6>
                                <div class="spinner-border text-danger" role="status">
                                    <span class="visually-hidden">Loading...</span>
                                </div>
                            </div>
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Placement Spinner</h5>
