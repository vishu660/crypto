...
<body>
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold mb-3">Sweet Alert</h5>
                            <button onclick="alerts_1()" class="btn bg-primary bg-opacity-10 text-primary m-1">Basic Alert</button>
                            <button onclick="alerts_2()" class="btn bg-warning bg-opacity-10 text-warning m-1">Alert</button>
                            <button onclick="alerts_3()" class="btn bg-info bg-opacity-10 text-info m-1">Input alert</button>
                            <button onclick="alerts_4()" class="btn bg-danger bg-opacity-10 text-danger m-1">Action</button>
                            <button onclick="alerts_5()" class="btn bg-success bg-opacity-10 text-success m-1">Success alert</button>
                        </div>
                    </div>
                </div>
                <!-- basic example -->
                <div class="col-12 mb-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold mb-3">Basic Examples</h5>
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold mb-3">Link colors</h5>
                            <div class="alert alert-primary" role="alert">
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold mb-3">Alerts with icon</h5>
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold mb-3">Dismissing alert</h5>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold mb-3">additional content</h5>
                            <div class="alert alert-success" role="alert">
                            ...
                            <div class="alert alert-warning" role="alert">
                                <h4 class="alert-heading">Simple Warning!</h4>
                                Aww yeah, you successfully read this important alert message. This example text is going to run a bit longer so that you can see how spacing within an alert works with this kind of content.
                                <hr>
                                Whenever you need to, be sure to use margin utilities to keep things nice and tidy.
                            </div>
    ...
    <script src="{{ asset('assets/js/sweetAlert/sweetalert_main.js') }}"></script>
    <!-- custom js -->
