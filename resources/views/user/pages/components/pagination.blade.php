                ...
                <ul class="navbar-nav flex-grow-1">
                    ...
                    <li class="nav-item active">
                        ...
                        <ul class="sub-menu collapse show" id="components">
                            ...
                            <!-- Child Menu Item -->
                            <li class="nav-item">
                                <a class="nav-link" href="../../pages/components/timeline.html">
                                    <span> Timeline </span>
                                </a>
                            </li>
                            <!-- End:Child Menu Item -->
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">Pagination</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="row">
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize">Basic Pagination</h5>
                        </div>
                        <div class="card-body">
                            <nav aria-label="Page navigation example">
                                <p class="text-muted">Default Bordered Pagination</p>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card bg-success bg-opacity-10">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize">Flat Pagination</h5>
                        </div>
                        <div class="card-body">
                            <nav aria-label="Page navigation example">
                                <p class="text-muted">For Flat Pagination add class</p>
                                <ul class="pagination d2c_flat_pagination mb-0">
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card bg-danger bg-opacity-10">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize">Rounded Pagination</h5>
                        </div>
                        <div class="card-body">
                            <nav aria-label="Page navigation example">
                                <p class="text-muted">For Bordered Rounded Pagination add class</p>
                                <ul class="pagination d2c_rounded_pagination mb-0">
                                    <li class="page-item"><a class="page-link" href="#"><i
                                                class="fas fa-chevron-left"></i></a></li>
                                    <li class="page-item active"><a class="page-link active" href="#">1</a></li>
                                    <li class="page-item"><a class="page-link" href="#">2</a></li>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card bg-warning bg-opacity-10">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize">Separated Pagination</h5>
                        </div>
                        <div class="card-body">
                            <nav aria-label="Page navigation example">
                                <p class="text-muted">For Separated Pagination add class</p>
                                <ul class="pagination d2c_separated_pagination mb-0">
                                    <li class="page-item"><a class="page-link ms-0" href="#"><i
                                                class="fas fa-chevron-left"></i></a></li>
                                    <li class="page-item active"><a class="page-link active" href="#">1</a></li>
                                    <li class="page-item"><a class="page-link" href="#">2</a></li>
                                    <li class="page-item"><a class="page-link" href="#">3</a></li>
                                    <li class="page-item"><a class="page-link" href="#">4</a></li>
                                    <li class="page-item"><a class="page-link me-0" href="#"><i
                                                class="fas fa-chevron-right"></i></a></li>
                                </ul>
                            </nav>
                        </div>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card bg-info bg-opacity-10">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize">Separated Rounded Pagination</h5>
                        </div>
                        <div class="card-body">
                            <nav aria-label="Page navigation example">
                                <p class="text-muted">For Separated Rounded Pagination add class</p>
                                <ul class="pagination d2c_separated_rounded mb-0">
                                    <li class="page-item"><a class="page-link" href="#"><i
                                                class="fas fa-chevron-left"></i></a></li>
                                    <li class="page-item active"><a class="page-link active" href="#">1</a></li>
                                    <li class="page-item"><a class="page-link" href="#">2</a></li>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize">Custom Pagination</h5>
                        </div>
                        <div class="card-body">
                            <p class="text-muted">Custom pagination with add class</p>
                            <nav aria-label="Page navigation">
                                <ul class="pagination d2c_custom_pagination mb-0 flex-wrap">
                                    <li class="page-item d-none d-sm-block"><a class="page-link ps-0 pe-2" href="#">First</a></li>
                                    <li class="page-item d-none d-sm-block"><a class="page-link px-0" href="#"><i class="fas fa-chevron-left"></i></a></li>
                                    <li class="page-item"><a class="page-link ps-2" href="#">Previous</a></li>
                                    <li class="page-item active"><a class="page-link d2c_page_number rounded-circle" href="#">1</a></li>
                                    <li class="page-item"><a class="page-link d2c_page_number" href="#">2</a></li>
                                    <li class="page-item"><a class="page-link d2c_page_number" href="#">3</a></li>
                                    <li class="page-item"><a class="page-link pe-2" href="#">Next</a></li>
                                    <li class="page-item d-none d-sm-block"><a class="page-link px-0" href="#"><i class="fas fa-chevron-right"></i></a></li>
                                    <li class="page-item d-none d-sm-block"><a class="page-link ps-2" href="#">Last</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
