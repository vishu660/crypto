...
<body>
            ...
            <div class="d-flex flex-column">
                ...
                <ul class="navbar-nav flex-grow-1">
                    ...
                    <li class="nav-item active">
                        ...
                        <!-- Child Sub Menu -->
                        <ul class="sub-menu collapse show" id="chart_dropdown">
                            <!-- Child Menu Item -->
                            <li class="nav-item">
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">Amm charts</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="row">
                ...
                <!-- column_with_label Chart -->
                <div class="col-xxl-6 mb-4">
                    <!-- Card -->
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">column with label Chart</h5>
                            <div id="column_with_label" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                <!-- End:column_with_label Chart -->
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">column Chart </h5>
                            <div id="d2c_column_chart" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                <!-- End:d2c_column_chart -->
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">stacked bar Chart</h5>
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">pie Chart</h5>
                            <div id="am_pie_chart" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                <!-- End:Overview am_pie_chart -->

                <!-- am_pie_chart_radius Chart -->
                <div class="col-xxl-6 mb-4">
                    <!-- Card -->
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">Variable Radius Pie Chart</h5>
                            <div id="am_pie_chart_radius" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                <!-- End:am_pie_chart_radius Chart -->
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">donut Chart</h5>
                            <div id="am_donut_Chart" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">solid gauge chart</h5>
                            <div id="solid_gauge" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                <!-- End:solid_gauge chart -->
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">Gantt Chart</h5>
                            <div id="gantt_chart" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                ...
                <!-- am_curved_columns Chart -->
                <div class="col-xxl-6 mb-4">
                    <!-- Card -->
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">Curve column Chart</h5>
                            <div id="am_curved_columns" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                <!-- End:am_curved_columns Chart -->

                <!-- am_radial_histogram Chart -->
                <div class="col-xxl-6 mb-4">
                    <!-- Card -->
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">Radial histogram Chart</h5>
                            <div id="am_radial_histogram" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                <!-- End:am_radial_histogram Chart -->
                        ...
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item position-relative me-3">
                                ...
                                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow border-0 py-0 mt-3">
                                    ...
                                    <a class=" dropdown-item text-center small text-gray-500 d2c_all_notification_btn" href="{{ route('user.pages.notification') }}">See All Notifications</a>
    ...
    <!-- Am charts -->
    <script src="{{ asset('lib/amcharts5/index.js') }}"></script>
    <script src="{{ asset('lib/amcharts5/xy.js') }}"></script>
    <script src="{{ asset('lib/amcharts5/percent.js') }}"></script>
    <script src="{{ asset('lib/amcharts5/radar.js') }}"></script>
    <script src="{{ asset('lib/amcharts5/Animated.js') }}"></script>
    <script src="{{ asset('lib/amcharts5/map.js') }}"></script>
    <script src="{{ asset('lib/amcharts5/worldLow.js') }}"></script>
    <script src="{{ asset('lib/amcharts5/micro.js') }}"></script>
    <script src="{{ asset('lib/amcharts5/responsive.js') }}"></script>
    <!-- js -->
