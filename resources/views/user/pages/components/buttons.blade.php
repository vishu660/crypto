                ...
                <ul class="navbar-nav flex-grow-1">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-menu collapse" id="authentication">
                            <!-- Child Menu Item -->
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('user.pages.auth.signUp') }}">
                                    <span> Sing up </span>
                                </a>
                            </li>
                            <!-- End:Child Menu Item -->
                            ...
                            <!-- Child Menu Item -->
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('user.pages.auth.signIn') }}">
                                    <span> Log In </span>
                                </a>
                            </li>
                            <!-- End:Child Menu Item -->
                            ...
                            <!-- Child Menu Item -->
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('user.pages.auth.forgetPassword') }}">
                            ...
                            <!-- Child Menu Item -->
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('user.pages.auth.lockscreen') }}">
                            ...
                            <!-- Child Menu Item -->
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('user.pages.auth.404') }}">
                                    <span> 404 </span>
                                </a>
                            </li>
                            <!-- End:Child Menu Item -->
                            ...
                            <!-- Child Menu Item -->
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('user.pages.auth.505') }}">
                                    <span> 505 </span>
                                </a>
                            </li>
                            <!-- End:Child Menu Item -->
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">Buttons</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="row">
                <div class="col-12 mb-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold mb-3">Hover Buttons</h5>
                            <button class="d2c_hover_btn btn_fill_top m-1">Slide Up</button>
                            <button class="d2c_hover_btn btn_fill_right m-1">Slide Right</button>
                            <button class="d2c_hover_btn btn_fill_down m-1">SlideDown</button>
                            <button class="d2c_hover_btn btn_fill_left m-1">Slide left</button>
                            <button class="d2c_hover_btn btn_fill_middle m-1">Slide Middle</button>
                            <button class="d2c_hover_btn btn_fill_middle_horizontal m-1">Slide left</button>
                        </div>
                    </div>
                    <!-- Hover Buttons -->
                </div>
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold mb-3">Details</h5>
                            <button class="d2c_detail_btn d2c_detail_top">Detail Top</button>
                            <button class="d2c_detail_btn d2c_detail_right">Detail Right</button>
                            <button class="d2c_detail_btn d2c_detail_bottom">Detail Bottom</button>
                            <button class="d2c_detail_btn d2c_detail_left">Detail Left</button>
                        </div>
                    </div>
                </div>
                <!-- default button -->
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Default Buttons</h5>
                            ...
                            <button type="button" class="btn btn-warning text-white m-1">Warning</button>
                            <button type="button" class="btn btn-info text-white m-1">Info</button>
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Outline Buttons</h5>
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Rounded Buttons</h5>
                            <button type="button" class="btn btn-outline-primary rounded-pill m-1">Primary</button>
                            <button type="button" class="btn btn-outline-secondary rounded-pill m-1">Secondary</button>
                            <button type="button" class="btn btn-outline-success rounded-pill m-1">Success</button>
                            <button type="button" class="btn btn-outline-danger rounded-pill m-1">Danger</button>
                            <button type="button" class="btn btn-outline-warning rounded-pill m-1">Warning</button>
                            <button type="button" class="btn btn-outline-info rounded-pill m-1">Info</button>
                            <button type="button" class="btn btn-outline-light rounded-pill m-1">Light</button>
                            <button type="button" class="btn btn-outline-dark m-1">Dark</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Button group</h5>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                <button type="button" class="btn btn-danger px-3 py-2">Left</button>
                                <button type="button" class="btn btn-warning px-3 py-2">Middle</button>
                                <button type="button" class="btn btn-success px-3 py-2">Right</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Outline Button group</h5>
                            <div class="btn-group" role="group" aria-label="Basic outlined example">
                                <button type="button" class="btn btn-outline-primary px-3 py-2">Left</button>
                                <button type="button" class="btn btn-outline-primary px-3 py-2">Middle</button>
                                <button type="button" class="btn btn-outline-primary px-3 py-2">Right</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Checkbox Button group</h5>
                            <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                <input type="checkbox" class="btn-check" id="btncheck1">
                                <label class="btn btn-outline-primary px-3 py-2" for="btncheck1">Check 1</label>
                              
                                <input type="checkbox" class="btn-check" id="btncheck2">
                                <label class="btn btn-outline-primary px-3 py-2" for="btncheck2">Check 2</label>
                              
                                <input type="checkbox" class="btn-check" id="btncheck3">
                                <label class="btn btn-outline-primary px-3 py-2" for="btncheck3">Check 3</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">radio Button group</h5>
                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio1" checked>
                                <label class="btn btn-outline-primary px-3 py-2" for="btnradio1">Radio 1</label>
                              
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio2">
                                <label class="btn btn-outline-primary px-3 py-2" for="btnradio2">Radio 2</label>
                              
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio3">
                                <label class="btn btn-outline-primary px-3 py-2" for="btnradio3">Radio 3</label>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- button with text icon button -->
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Button text with icon</h5>
                            <button type="button" class="btn btn-primary m-1"><i class="far fa-star"></i> Primary</button>
                            <button type="button" class="btn btn-secondary m-1"><i class="fas fa-desktop"></i> Secondary</button>
                            <button type="button" class="btn btn-success m-1"><i class="far fa-check-circle"></i> Success</button>
                            <button type="button" class="btn btn-danger m-1"><i class="fas fa-exclamation-circle"></i> Danger</button>
                            <button type="button" class="btn btn-warning text-white m-1"><i class="fas fa-exclamation-triangle"></i> Warning</button>
                            <button type="button" class="btn btn-info text-white m-1"><i class="fas fa-info-circle"></i> Info</button>
                            <button type="button" class="btn btn-light m-1"><i class="far fa-clone"></i> Light</button>
                            <button type="button" class="btn btn-dark m-1"><i class="fas fa-adjust"></i> Dark</button>
                            <button type="button" class="btn btn-link m-1"><i class="fas fa-link"></i> Link</button>
                        </div>
                    </div>
                </div>
                <!-- icon button -->
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Icon Button</h5>
                            <button type="button" class="btn btn-primary m-1"><i class="far fa-star"></i></button>
                            <button type="button" class="btn btn-secondary m-1"><i class="fas fa-desktop"></i></button>
                            <button type="button" class="btn btn-success m-1"><i class="far fa-check-circle"></i></button>
                            <button type="button" class="btn btn-danger m-1"><i class="fas fa-exclamation-circle"></i></button>
                            <button type="button" class="btn btn-warning text-white m-1"><i class="fas fa-exclamation-triangle"></i></button>
                            <button type="button" class="btn btn-info text-white m-1"><i class="fas fa-info-circle"></i></button>
                            <button type="button" class="btn btn-light m-1"><i class="far fa-clone"></i></button>
                            <button type="button" class="btn btn-dark m-1"><i class="fas fa-adjust"></i></button>
                            <button type="button" class="btn btn-link m-1"><i class="fas fa-link"></i></button>
                        </div>
                    </div>
                </div>
                <!-- social icon button -->
                <div class="col-xl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Social icon Button</h5>
                            <button type="button" class="btn btn-primary m-1 px-3 py-1"><i class="fab fa-facebook-f"></i></button>
                            <button type="button" class="btn btn-secondary m-1 px-3 py-1"><i class="fab fa-instagram"></i></button>
                            <button type="button" class="btn btn-success m-1 px-3 py-1"><i class="fab fa-youtube"></i></button>
                            <button type="button" class="btn btn-danger m-1 px-3 py-1"><i class="fab fa-linkedin-in"></i></button>
                            <button type="button" class="btn btn-warning text-white m-1 px-3 py-1"><i class="fab fa-twitter"></i></button>
                            <button type="button" class="btn btn-primary m-1 px-3 py-1"><i class="fab fa-dribbble"></i></button>
                            <button type="button" class="btn btn-secondary m-1 px-3 py-1"><i class="fab fa-behance"></i></button>
                            <button type="button" class="btn btn-success m-1 px-3 py-1"><i class="fab fa-tiktok"></i></button>
                        </div>
                    </div>
                </div>
                <!-- button states -->
                <div class="col-xl-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Button States</h5>
                            <button type="button" class="btn btn-primary mb-2">Normal</button>
                            <button type="button" class="btn btn-primary mb-2" disabled>Disable</button>
                            <button type="button" class="btn btn-outline-primary mb-2">Normal</button>
                            <button type="button" class="btn btn-outline-primary mb-2" disabled>Disable</button>
                        </div>
                    </div>
                </div>
                <!-- Button SIzes -->
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-capitalize mb-3">Button SIzes</h5>
                            <button type="button" class="btn btn-primary btn-sm mb-2">Small button</button>
                            <button type="button" class="btn btn-secondary mb-2">Normal button</button>
                            <button type="button" class="btn btn-success btn-lg mb-2">Large button</button>
                            <button type="button" class="btn btn-outline-primary btn-sm mb-2">Primary</button>
                            <button type="button" class="btn btn-outline-secondary mb-2">Secondary</button>
                            <button type="button" class="btn btn-outline-success btn-lg mb-2">Success</button>
                            <!-- block button -->
