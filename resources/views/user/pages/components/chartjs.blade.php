        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">chart JS</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="row">
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">Line Chart</h5>
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">Bubble Chart</h5>
                            <canvas id="d2c_bubble_chart"></canvas>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                <!-- End:d2c_bubble_chart -->
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">polar Chart</h5>
