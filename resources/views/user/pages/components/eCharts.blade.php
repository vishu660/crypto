...
<body>
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">E-charts</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="row">
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-header">
                            <h5 class="text-capitalize fw-semibold">Bar Chart</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">Radial Polar Bar Chart </h5>
                            <div id="radial_polar_bar" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                <!-- End:Radial Polar Bar Chart -->
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">Basic Line Chart</h5>
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">Area Chart</h5>
                            <div id="area_chart" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                <!-- End:Overview Area Chart -->
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-success bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">doughnut Chart</h5>
                            <div id="doughnut_chart" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-success bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">radar Chart</h5>
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-primary bg-opacity-10">
                        <div class="card-header">
                            <h5 class="text-capitalize fw-semibold">scatter Chart</h5>
                        </div>
                ...
                <div class="col-xxl-6 mb-4">
                    ...
                    <div class="card bg-danger bg-opacity-10">
                        <div class="card-body">
                            <h5 class="text-capitalize fw-semibold">candlestick Chart</h5>
                            <div id="candlestick_chart" style="width: 100%;height:350px;"></div>
                        </div>
                    </div>
                    <!-- Card -->
                </div>
                <!-- End:candlestick_chart Chart -->
    ...
    <script src="{{ asset('lib/e_charts/e_charts.min.js') }}"></script>
    <script src="{{ asset('assets/js/chart/echart.js') }}"></script>
