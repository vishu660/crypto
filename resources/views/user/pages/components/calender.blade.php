...
<body>
        ...
        <div class="d2c_main p-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col">
                    ...
                    <h4 class="text-capitalize fw-bold">Calender</h4>
                </div>
            </div>
            <!-- End:Title -->
            ...
            <div class="card h-auto">
                <div class="card-body">
                    <!-- Row -->
                    <div class="row d2c_event_calender">
                        <div class="col-xxl-3 col-lg-4 mb-4">
                            <div class="card h-auto">
                                <div class="card-header text-primary fw-cold">Events</div>
                                <div class="card-body pt-0">
                                    ...
                                    <button class="btn btn-primary rounded w-100 px-3 py-1">Add Event</button>
                                </div>
                            </div>
                        </div>
    ...
    <!-- FullCalender Config -->
    <script src="{{ asset('lib/fullcalender/index.global.min.js') }}"></script>
    <script src="{{ asset('assets/js/fullcalender/script.js') }}"></script>
</body>
