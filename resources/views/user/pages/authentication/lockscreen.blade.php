        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-5 mx-xl-auto">
                    <div class="d2c_login_wrapper d2c_lockscreen">
                        <div class="text-center mb-4">
                            <img src="{{ asset('assets/images/avatar/man-2.png') }}" class="d2c_user_avatar" alt="user image">
                            <h4>David M.</h4>
                        </div>
                        <form action="#">
                            <div class="mb-3">
                            ...
                            <button type="submit"
                                class="btn btn-primary w-100 text-capitalize">Unlock</button>
                        </form>
                    </div>
                </div>
            </div>
