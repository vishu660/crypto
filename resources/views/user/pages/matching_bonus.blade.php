...
@section('content')
<div class="container" style="max-width:1200px; margin-top:40px; margin-left:0;">
    <div class="row mb-3">
        <div class="col-12">
                ...
                <div class="table-responsive">
                    <table class="table table-borderless align-middle mb-0" style="font-size:0.97rem; min-width:900px; max-width:1150px; margin:auto;">
                        <thead style="background:#bfc9d1;">
                            <tr>
                                <th class="fw-bold" style="font-size:1rem;">Left</th>
                                <th class="fw-bold" style="font-size:1rem;">Right</th>
                                <th class="fw-bold" style="font-size:1rem;">Matching</th>
                                <th class="fw-bold" style="font-size:1rem;">Left Carry</th>
                                <th class="fw-bold" style="font-size:1rem;">Right Carry</th>
                                <th class="fw-bold" style="font-size:1rem;">Capping</th>
                                <th class="fw-bold" style="font-size:1rem;">Matching Bonus</th>
