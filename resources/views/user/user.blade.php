...
@section('content')
    ...
    <div class="card d2c_wallet_card mb-4"
        style="background: linear-gradient(180deg, #23cb62e0 0%, #6271ebd6 270.67%), url(./assets/images/triangle_bg.png); background-repeat: no-repeat; background-size: cover;">
        <div class="card-body">
            <div class="mb-4">
