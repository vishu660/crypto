                ...
                <div class="row mb-3 border-bottom pb-2">
                    ...
                    <div class="col-8">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <a href="./pages/profile.html"><img class="rounded-circle" src="{{asset('assets/images/profile/profile-2.jpg')}}" alt="Profile Image" style="height: 40px; width: 40px; object-fit: cover;"></a>
                            </div>
                        </div>
                    </div>
                </div>
