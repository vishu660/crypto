...
<div class="members-container">
    <div class="row">
        <div class="col-12">
            <p class="text-white"><a href="{{ route('admin-dashboard') }}" style="color:#00fff7; text-decoration:underline;">Dashboard</a>/Team /Inactive Members</p>
        </div>
    </div>
    <h2 class="members-title">Inactive Members</h2>
