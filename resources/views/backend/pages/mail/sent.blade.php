...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h4 class="breadcrumb-title">
                ...
                <a href="{{ route('admin.mail.sent') }}" style="color:#00fff7; text-decoration:none;">Sent</a>
            </h4>
        </div>
    </div>
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-9">
            <div class="mail-card">
                <h5 class="card-title mb-4">📤 Sent Mail</h5>
                
                @forelse($messages as $msg)
                    <div class="p-4 mb-4 rounded shadow-sm" style="background-color: #101820; border: 1px solid #00fff7;">
                        <p class="mb-1"><strong style="color:#00fff7;">To:</strong> {{ $msg->receiver->full_name ?? 'Unknown' }}</p>
                ...
                @empty
                    <p class="text-muted">No sent messages found.</p>
                @endforelse
